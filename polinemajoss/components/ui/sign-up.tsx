  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Form - Kanan */}
        <div className="bg-white w-1/2 max-h-[95vh] overflow-y-auto rounded-[15px] shadow-md mx-[2%] p-8 pt-10">
            ...
            <div className="flex flex-col justify-between gap-7">
              ...
              <form onSubmit={handleSignUp} className="flex flex-col gap-6 w-full">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="remember">I agree with the terms of use of HRIS</Label>
                </div>
